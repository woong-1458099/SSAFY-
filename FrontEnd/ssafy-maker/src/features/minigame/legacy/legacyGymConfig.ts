...
const LEGACY_GYM_RESULT_RULES: Array<{
  ...
  { minReps: LEGACY_GYM_MAX_REPS, minPerfectRate: 0.7, grade: "S", gradeColor: "#ffd700", message: "🏆 완벽한 퍼포먼스!", reward: "HPMAX +6, TEAMWORK +3" },
  { minReps: LEGACY_GYM_MAX_REPS, grade: "A", gradeColor: "#44ff88", message: "💪 훌륭해요!", reward: "HPMAX +4, TEAMWORK +2" },
  { minReps: 7, grade: "B", gradeColor: "#4499ff", message: "👍 좋아요!", reward: "HPMAX +3, TEAMWORK +1" },
