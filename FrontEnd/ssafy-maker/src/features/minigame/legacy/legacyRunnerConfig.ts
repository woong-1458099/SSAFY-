...
const LEGACY_RUNNER_RESULT_RULES = [
  { minScore: 3000, grade: "S", gradeColor: "#FFD700", reward: "LUCK +6, TEAMWORK +3" },
  { minScore: 1500, grade: "A", gradeColor: "#00ff88", reward: "LUCK +4, TEAMWORK +2" },
  { minScore: 800, grade: "B", gradeColor: "#4499ff", reward: "LUCK +2, TEAMWORK +1" },
  { minScore: 0, grade: "C", gradeColor: "#ff4466", reward: "LUCK +1" },
] as const;
