...
export const LEGACY_COOKING_DISHES = [
  { minScore: 1100, name: "🏆 황금 라면", desc: "전설의 라면이 완성되었습니다!", color: "#FFD700", reward: "HP +10, BE +4" },
  { minScore: 900, name: "🍜 특제 라면", desc: "정말 맛있는 라면이네요!", color: "#ff8844", reward: "HP +8, BE +3" },
  { minScore: 700, name: "🍥 맛있는 라면", desc: "훌륭한 라면입니다!", color: "#44ff88", reward: "HP +6, BE +2" },
  { minScore: 400, name: "🥢 평범한 라면", desc: "그럭저럭 먹을만 해요", color: "#88ccff", reward: "HP +4, BE +1" },
