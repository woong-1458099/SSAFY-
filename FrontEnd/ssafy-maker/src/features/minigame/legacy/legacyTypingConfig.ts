...
const LEGACY_TYPING_RESULT_RULES = [
  { minScore: 500, grade: "S", gradeColor: "#FFD700", message: "🏆 타이핑 마스터!", reward: "지능 +10, GP +30" },
  { minScore: 300, grade: "A", gradeColor: "#44ff88", message: "⚡ 훌륭해요!", reward: "지능 +7, GP +20" },
  { minScore: 150, grade: "B", gradeColor: "#4499ff", message: "👍 좋아요!", reward: "지능 +5, GP +10" },
  { minScore: 0, grade: "C", gradeColor: "#ff8844", message: "💪 연습이 필요해요", reward: "지능 +2, 스트레스 +5" },
] as const;
