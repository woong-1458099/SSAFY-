...
export const WEEKLY_PLAN_OPTIONS: WeeklyPlanOption[] = [
  {
    id: "ui_practice",
    label: "UI 구현 연습",
    description: "FE +6 / HP -20 / 스트레스 +2",
    statDelta: { fe: 6, stress: 2 },
    hpDelta: -20,
    color: 0x4c8ed9
  },
  {
    ...
    description: "BE +6 / HP -20 / 스트레스 +2",
    statDelta: { be: 6, stress: 2 },
    hpDelta: -20,
    color: 0x3d9d7a
  },
  {
    id: "team_project",
    label: "팀 프로젝트",
    description: "협업 +6 / HP -20 / 스트레스 +2",
    statDelta: { teamwork: 6, stress: 2 },
    hpDelta: -20,
    color: 0xb68543
  }
];
