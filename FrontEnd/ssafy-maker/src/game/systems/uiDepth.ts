...
export const UI_DEPTH = {
  ...
  worldGridManualBlocked: SCREEN_UI_BASE + 502,
  worldGridInteraction: SCREEN_UI_BASE + 503,
  worldGridPlacePrompt: SCREEN_UI_BASE + 504,
  ...
  debugTileEditor: SCREEN_UI_BASE + 1450,
