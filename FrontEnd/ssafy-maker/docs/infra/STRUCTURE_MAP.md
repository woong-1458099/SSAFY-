...
- `src/scenes/legacyMinigames`: 레거시 및 개별 미니게임 로직
...
## Review Hints
- 미니게임 추가 시: `app/registry`, `features/minigame`, `scenes/legacyMinigames` 세 곳의 정합성을 확인한다.
- NPC 대화 변경 시: `features/story` 어댑터와 `MainScene`의 호출 로직을 확인한다.
