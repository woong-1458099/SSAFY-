...
- Keep autosave scheduling policy in `src/game/scenes/main/autoSaveCoordinator.ts`, while activity/idle semantics stay with `src/game/managers/PlayerManager.ts`.
